...
class PaymentServiceTest {
	...
	void testAssignSubscription_NewSubscription_Success() {
		...
		AssignSubscriptionRequest request = new AssignSubscriptionRequest(2L, LocalDateTime.now(), "CREDIT_CARD");
	...
	void testAssignSubscription_CurrentSubscriptionActive_HigherPriority() {
		String userEmail = "test@domain.com";
		AssignSubscriptionRequest request = new AssignSubscriptionRequest(3L, LocalDateTime.now(), "PAYPAL");
	...
	void testAssignSubscription_CurrentSubscriptionActive_LowerPriority() {
		String userEmail = "test@domain.com";
		AssignSubscriptionRequest request = new AssignSubscriptionRequest(1L, LocalDateTime.now(), "CASH");
		...
		assertEquals("Cannot assign new subscription because the current subscription has not ended.",
